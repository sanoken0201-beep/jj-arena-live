...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        for width, height, mobile, keyboard, drawer in cases:
            ...
            assert 'data-ok="1"' in dom, f"phase4 layout failed {width}x{height} mobile={mobile} keyboard={keyboard} drawer={drawer}: {dom[-2400:]}"
