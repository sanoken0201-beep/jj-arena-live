...
def main() -> None:
    ...
    css = phase5_css(phase4_css(phase3_css(phase2_css(css))))
    with tempfile.TemporaryDirectory() as td:
        ...
        for width, height in ((390, 844), (360, 800), (1366, 768)):
            for compact in (False, True):
                ...
                assert 'data-ok="1"' in dom, f"phase5 layout failed {width}x{height} compact={compact}: {dom[-1600:]}"
