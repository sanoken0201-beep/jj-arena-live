...
# All browser mutations, including historical rake-copy cleanup and removed
# poker controls, are now compiled into `.jj_build` by build_served_assets.py.
# Production serves those canonical bytes without request-time transforms.
