...
def _patched_app_js() -> str:
    ...
    # Telemetry is attached after the performance/copy transforms so it observes
    # the exact client implementation served to production without changing the
    # optimized state/chat frame behavior above.
