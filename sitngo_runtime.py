...
class TournamentRuntime:
    def __init__(self, service, ring_engine):
        ...
        with self.db.connect() as con:
            ...
            con.execute("CREATE INDEX IF NOT EXISTS idx_sitngo_hands_event_created ON sitngo_hands(event_id,created_at)")
            con.execute("CREATE INDEX IF NOT EXISTS idx_sitngo_messages_event_created ON sitngo_messages(event_id,created_at)")
