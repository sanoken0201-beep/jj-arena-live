...
import base64, hashlib, io, re, tarfile, tempfile
...
import v15_patch,v16_patch,v17_patch,v18_patch,v19_patch,v20_patch,v21_patch,v22_patch,v23_patch,v24_patch,v25_patch,v26_patch,v27_patch,v28_patch,v29_patch,v30_patch,v31_patch,v32_patch,v33_patch,v34_patch
for fn in [v15_patch.apply,v16_patch.apply,v17_patch.apply]: fn(DEST)
v18_patch.apply(DEST,ROOT/'v18_assets')
for mod in [v19_patch,v20_patch,v21_patch,v22_patch,v23_patch,v24_patch,v25_patch,v26_patch,v27_patch,v28_patch,v29_patch,v30_patch,v31_patch,v32_patch,v33_patch,v34_patch]: mod.apply(DEST)

files=[DEST/'static/index.html',DEST/'static/app.js',ROOT/'admin_static/index.html',ROOT/'admin_static/admin.js',ROOT/'admin_static/admin_delete.js']
seen=set(); out=[]
