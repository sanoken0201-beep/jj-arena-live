...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # product output. Stage 7B intentionally validates the served behavior
        # instead of retaining a dependency on the historical patch source that
        # originally introduced this presentation layer.
