...
def main() -> None:
    ...
    # Legacy member reads remain compatible, but writes must resolve only to the
    # explicit retired/tombstone endpoints. Canonical writes live under console.
    ...
    assert matches("/api/admin/members", "GET"), "read-only compatibility route missing"
